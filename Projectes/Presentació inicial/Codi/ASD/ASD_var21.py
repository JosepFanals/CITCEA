...
df_b = pd.read_excel('ASD/data_IEEE30.xlsx', sheet_name="buses")
df_l = pd.read_excel('ASD/data_IEEE30.xlsx', sheet_name="lines")
...
gamma = 0.08  # try different values
