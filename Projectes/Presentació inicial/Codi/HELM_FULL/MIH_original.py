...
df_top = pd.read_excel('HELM_FULL/IEEE30.xlsx', sheet_name='Topologia')  # dades de la topologia
df_bus = pd.read_excel('HELM_FULL/IEEE30.xlsx', sheet_name='Busos')  # dades dels busos
...
from Funcions import pade4all, Sigma  # importar funcions
