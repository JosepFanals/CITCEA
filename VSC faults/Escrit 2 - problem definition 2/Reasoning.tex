...
\begin{equation}
    \begin{cases}
        \underline{V}^+_c= \dfrac{1}{\underline{Z}_f + \underline{Z}_{th}}[\underline{V}^+_{th}\underline{Z}_f + \underline{I}^+(\underline{Z}_a\underline{Z}_f + \underline{Z}_a\underline{Z}_{th} + \underline{Z}_f\underline{Z}_{th})] \vspace{0.4cm} \\ 
...
\begin{equation}
    \begin{cases}
        \underline{V}^+_c=\dfrac{1}{3\underline{Z}_f + 3\underline{Z}_{th}} [\underline{V}^+_{th} (3\underline{Z}_f + 2\underline{Z}_{th}) + \underline{I}^+(3\underline{Z}_a\underline{Z}_f + 3\underline{Z}_a\underline{Z}_{th} + 3\underline{Z}_{th}\underline{Z}_f + 2\underline{Z}^2_{th}) + \underline{I}^-(-\underline{Z}^2_{th})  ] \vspace{0.4cm} \\ 
 \underline{V}^-_c=\dfrac{1}{3Z_f + 3Z_{th}}[\underline{V}^+_{th} (-\underline{Z}_{th}) + \underline{I}^+(-\underline{Z}^2_{th}) + \underline{I}^-(3\underline{Z}_a\underline{Z}_f + 3\underline{Z_a}\underline{Z}_{th} + 3\underline{Z}_f\underline{Z}_{th} + 2\underline{Z}^2_{th} )  ]
    \end{cases}
\end{equation}
