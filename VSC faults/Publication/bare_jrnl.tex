...
These variables are related via the $\mathbf{\un{Y}_{vk}}$ admittance submatrices, which represent the connection between the point of common coupling PCCk and the corresponding node of the grid. 
