...
\begin{cases} 
   ...
   \end{cases}
\end{equation}
Constants $k_p$ and $k_n$ are initially set at 2.5. If necessary, they are dynamically adjusted so that no current limitations are exceeded. 
...
\draw[line width=0.65mm] (-5.125,1.85) to [short] (-5.125,0.85);
\draw (-6.875, 1.35) to [short] (-7.125, 1.35);
\draw (-7.125, 1.35) to [sdcac] (-8.125, 1.35);
\node at (-7.625,1.95) {VSC1};
\node at (-5.125,2.05) {$\underline{V}_{p1}$};
...
\draw (-5.625, 0.55) to [short, i=$\un{I}_2$] (-5.125, 0.55);
\draw (-6.875, 0.55) to [R, l=$\un{Z}_{z2}$, european] (-5.625, 0.55);
\draw[line width=0.65mm] (-5.125,0.05) to [short] (-5.125,1.05);
\draw (-6.875, 0.55) to [short] (-7.125, 0.55);
\draw (-7.125, 0.55) to [sdcac] (-8.125, 0.55);
\node at (-7.625,1.15) {VSC2};
\node at (-5.125,1.25) {$\underline{V}_{p2}$};

\draw (-3.25, 2.1) to [short] (-3.75, 2.1);
\draw (-3.75, 2.1) to [R, l_=$\un{Z}_{v1}$, european] (-5.0, 2.1);
\draw (-5,2.1) to [short] (-5.125, 2.1);
\draw (-5.625, 2.1) to [short, i=$\un{I}_1$] (-5.125, 2.1);
\draw (-6.875, 2.1) to [R, l=$\un{Z}_{z1}$, european] (-5.625, 2.1);
\draw[line width=0.65mm] (-5.125,1.6) to [short] (-5.125,2.6);
\draw (-6.875, 2.1) to [short] (-7.125, 2.1);
\draw (-7.125, 2.1) to [sdcac] (-8.125, 2.1);
\node at (-7.625,2.7) {VSC1};
\node at (-5.125,2.80) {$\underline{V}_{p1}$};
...
\draw (-3.5,1.35) to [short] (-3.3,1.35);
...
% \draw (-3.25, 1.35) to [short] (-3.75, 1.35);
\draw (-3.5, 1.35) to [R, l_=$\un{Z}_{v1}$, european] (-5.0, 1.35);
\draw (-5,1.35) to [short] (-5.125, 1.35);
\draw (-5.625, 1.35) to [short, i=$\un{I}_1$] (-5.125, 1.35);
\draw (-6.875, 1.35) to [R, l=$\un{Z}_{z1}$, european] (-5.625, 1.35);
\draw[line width=0.65mm] (-5.125,1.85) to [short] (-5.125,0.85);
...
\end{circuitikz}
\caption{Single-phase representation of the single converter connected to a system with a submarine cable}
\label{fig:sys_c1}
\end{figure}
