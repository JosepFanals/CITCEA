...
\draw[line width=0.4mm, dotted] (4.325,3) to [short] (4.325,-0.85);
\draw[line width=0.4mm, dotted] (4.325,3) to [short] (6.95,3);
\draw[line width=0.4mm, dotted] (4.325,-0.85) to [short] (6.95,-0.85);
\draw[line width=0.4mm, dotted] (6.95,3) to [short] (6.95,-0.85);

\draw[line width=0.4mm, dotted] (0.5,3.05) to [short] (0.5,-0.9);
\draw[line width=0.4mm, dotted] (0.5,3.05) to [short] (2.95,3.05);
\draw[line width=0.4mm, dotted] (2.95,3.05) to [short] (2.95,-0.9);
\draw[line width=0.4mm, dotted] (0.5,-0.9) to [short] (2.95,-0.9);

\node at (1.725,3.2) {VSC average model};
