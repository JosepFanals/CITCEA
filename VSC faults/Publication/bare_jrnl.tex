...
\begin{subfigure}[!htb]{0.4\textwidth}
        ...
        \end{subfigure}
    \end{center}
    \caption{Influence of the currents for the line to line fault with a varying $R_1/X_1$ ratio and $\un{Z}_x=10$ in a two-converter case}
