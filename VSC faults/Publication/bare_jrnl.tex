...
Consider a generic distribution of positive and negative sequence voltages in the complex plane, as in Fig. \ref{fig:map}. 
...
% draw figure in tikz, like the one in inkscape
...
\begin{itemize}
  ...
  \item GCN: follows the grid code negative sequence current injection shown in \eqref{eq:gc2}. Just like GCP, the converter will continuously operate under saturation conditions. 
\end{itemize}
