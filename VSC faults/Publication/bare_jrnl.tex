...
\begin{subfigure}[!htb]{0.4\textwidth}
  ...
  \end{figure}
Significantly different results are obtained in the case of a line to line fault, as shown in Figure \ref{fig:Zf_1conv_LL}. This unbalanced fault causes the optimal currents to be non-null for the negative sequence. 
