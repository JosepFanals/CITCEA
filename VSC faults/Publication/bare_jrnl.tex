...
Given a basic system as the one depicted in Figure XX, the goal is to optimize the voltages at the point of common coupling. The fault is symbolized by a generic fault impedance, which in reality can represent either a balanced or unbalanced fault.

% place figure of the basic system
