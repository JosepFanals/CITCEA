...
On the contrary, the admittance matrix $\mathbf{\un{Y}_g}$ is a $3n_g \times 3n_g$ matrix also built by observation. 

Voltages are expressed as a transformation of currents by computing the inverse of the general admittance matrix. 
