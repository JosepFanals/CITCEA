...
\begin{cases} 
      ...
      |\un{I}^+_k| = I_{\text{max},k} & |\un{V}^+_{pk}| < 0.5  \\
   \end{cases}
   \label{eq:gc1}
\end{equation}
...
\begin{cases} 
   ...
   \label{eq:gc2}
\end{equation}
Both constants $k_p$ and $k_n$ are set at $1.25I_{\text{max},k}$. This value was found to be the theoretical maximum so that current limitations are not reached in the worst case scenario where $|\un{V}^+_{pk}|=0.5$ and $|\un{V}^-_{pk}|=0.5$.
...
\begin{subfigure}[!htb]{0.4\textwidth}
  ...
  \end{figure}
Significantly different results are obtained in the case of a line to ground fault. This unbalanced fault causes the optimal currents to be non-null for the negative sequence. 
      ...
      \centering
          \begin{tikzpicture}[trim axis right,trim axis left]
              ...
              \begin{axis}[grid=major, xlabel={$\un{Z}_x$}, ylabel={${I}^+_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.005}, axis line style = thick, ytick distance={0.05}, xmin=0.02, xmax=0.04, scaled y ticks=false, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}, scaled x ticks=false, xticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Results_1conv_Zf_v1/sta_LG_Ip1re.csv};
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Z}_x$}, ylabel={${I}^+_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.005}, axis line style = thick, xmin=0.02, xmax=0.04, ytick distance = {0.1}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}, scaled x ticks=false, xticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Results_1conv_Zf_v1/sta_LG_Ip1im.csv};
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Z}_x$}, ylabel={${I}^-_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.005}, axis line style = thick, xmin=0.02, xmax=0.04, ytick distance = {0.1}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}, scaled x ticks=false, xticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Results_1conv_Zf_v1/sta_LG_In1re.csv};
      ...
      \begin{subfigure}[!htb]{.12\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Results_1conv_Zf_v1/sta_LG_In1im.csv};
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Z}_x$}, ylabel={$|V^+|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.005}, axis line style = thick, xmin=0.02, xmax=0.04, ytick distance = {0.02}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}, scaled x ticks=false, xticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Results_1conv_Zf_v1/sta_LG_Vp1.csv};
      ...
      \begin{subfigure}[!htb]{.12\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Results_1conv_Zf_v1/sta_LG_Vn1.csv};
...
\begin{subfigure}[!htb]{0.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Results_1conv_Zf_v1/sta_LG_f_obj.csv};
