...
\begin{subfigure}[!htb]{0.4\textwidth}
        ...
        \end{subfigure}
    \end{center}
    \caption{Influence of the currents on the objective function for the line to line fault with a varying $R_1/X_1$ ratio and $\un{Z}_{ab}=0.1$}
...
\begin{subfigure}[!htb]{0.4\textwidth}
        ...
        \end{subfigure}
    \end{center}
    \caption{Influence of the currents on the objective function for the double line to ground fault with a varying $R_1/X_1$ ratio and $\un{Z}_{ag}=0.1$}
