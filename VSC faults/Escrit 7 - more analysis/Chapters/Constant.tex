...
\addplot3 [scatter, only marks, ycomb, each nth point = 2] table[x=x, y=y, z=z, col sep=comma] {Data/constant/ff_3x.csv};
\addplot3 [name path=B, gray, no markers, line width=1pt] table[x=x, y=y, z=z, col sep=comma] {Data/constant/terra.csv};
\addplot3 [domain=-0:1,samples=31, samples y=0, very thick, smooth]  table[x=x, y=y, z=z, col sep=comma] {Data/constant/V1_3x.csv};
\addplot3 [domain=-0:1,samples=31, samples y=0, very thick, smooth]  table[x=x, y=y, z=z, col sep=comma] {Data/constant/V2_3x.csv};

\node at (axis cs:0.4,0.3,0.56) [pin=130:$|V^-_c|$] {};
\node at (axis cs:0.1,0.8,0.75) [pin=-90:$|V^+_c|$] {};
\end{axis}
\end{tikzpicture}
\caption{Positive and negative sequence voltages together with the objective function for the balanced fault}
\label{fig:full_3x}
\end{figure}
