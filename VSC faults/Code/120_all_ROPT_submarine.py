...
make_csv(dist_vec, np.real(I1_vec), a_vec, 'Data/dist/RI1_re_LL.csv')
make_csv(dist_vec, np.imag(I1_vec), a_vec, 'Data/dist/RI1_im_LL.csv')
make_csv(dist_vec, np.real(I2_vec), a_vec, 'Data/dist/RI2_re_LL.csv')
make_csv(dist_vec, np.imag(I2_vec), a_vec, 'Data/dist/RI2_im_LL.csv')
make_csv(dist_vec, ff_vec, a_vec, 'Data/dist/Rff_LL.csv')

make3_csv(dist_vec, one_vec, np.abs(V1_vec), 'Data/dist/RV1_LL.csv')
make3_csv(zero_vec, dist_vec, np.abs(V2_vec), 'Data/dist/RV2_LL.csv')
make3_csv(dist_vec, dist_vec, ff_vec, 'Data/dist/RffG_LL.csv')
