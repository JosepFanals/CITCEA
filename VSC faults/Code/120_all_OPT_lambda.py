...
make3_csv(lam_vec, one_vec, np.abs(V1_vec), 'Data/constant/V1_LLG.csv')
make3_csv(one_vec, lam2_vec, np.abs(V2_vec), 'Data/constant/V2_LLG.csv')
make3_csv(lam_vec, lam2_vec, ff_vec, 'Data/constant/ff_LLG.csv')
