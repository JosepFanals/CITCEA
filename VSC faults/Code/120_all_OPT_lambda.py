...
# make_csv(lam_vec, np.real(I1_vec), a_vec, 'Data/constant/I1_re_3x.csv')
# make_csv(lam_vec, np.imag(I1_vec), a_vec, 'Data/constant/I1_im_3x.csv')
...
make3_csv(lam_vec, one_vec, np.abs(V1_vec), 'Data/constant/V1_LL.csv')
make3_csv(one_vec, lam2_vec, np.abs(V2_vec), 'Data/constant/V2_LL.csv')
make3_csv(lam_vec, lam2_vec, ff_vec, 'Data/constant/ff_LL.csv')
