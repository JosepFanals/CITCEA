...
make3_csv(RX_vec, one_vec, np.abs(V1_vec), 'Data/RX/RV1_LLG.csv')
make3_csv(zero_vec, RX_vec, np.abs(V2_vec), 'Data/RX/RV2_LLG.csv')
make3_csv(RX_vec, RX_vec, ff_vec, 'Data/RX/RffG_LLG.csv')
