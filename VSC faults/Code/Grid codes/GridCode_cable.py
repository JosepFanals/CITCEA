...
one_vec = np.full(len(dist_vec), 5)
a_vec = np.full(len(dist_vec), 'a')
b_vec = 'b'

make_csv(dist_vec, np.real(I1_vec), a_vec, 'Optimal/Data/dist/GI1_re_3x.csv')
make_csv(dist_vec, np.imag(I1_vec), a_vec, 'Optimal/Data/dist/GI1_im_3x.csv')
make_csv(dist_vec, np.real(I2_vec), a_vec, 'Optimal/Data/dist/GI2_re_3x.csv')
make_csv(dist_vec, np.imag(I2_vec), a_vec, 'Optimal/Data/dist/GI2_im_3x.csv')
make_csv(dist_vec, ff_vec, a_vec, 'Optimal/Data/dist/Gff_3x.csv')

make_csv(dist_vec, np.abs(V1_vec), a_vec, 'Optimal/Data/dist/GV1_3x.csv')
make_csv(dist_vec, np.abs(V2_vec), a_vec, 'Optimal/Data/dist/GV2_3x.csv')
make_csv(dist_vec, ff_vec, a_vec, 'Optimal/Data/dist/GffG_3x.csv')
