...
for lamm in range(0,100,1):
    ...
    Imax = 1
    Vth_1 = 1  # positive sequence Thévenin voltag
...
# make_csv(RX_vec, np.real(I1_vec), a_vec, 'Optimal/Data/gridcode/GI1_re_LLG.csv')
# make_csv(RX_vec, np.imag(I1_vec), a_vec, 'Optimal/Data/gridcode/GI1_im_LLG.csv')
# make_csv(RX_vec, np.real(I2_vec), a_vec, 'Optimal/Data/gridcode/GI2_re_LLG.csv')
...
make_csv(RX_vec, np.abs(V1_vec), 'Optimal/Data/constant/GV1_3x.csv')
make_csv(RX_vec, np.abs(V2_vec), 'Optimal/Data/constant/GV2_3x.csv')
