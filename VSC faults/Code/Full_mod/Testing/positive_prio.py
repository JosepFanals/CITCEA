import numpy as np
from Functions import Inmax, Current_data
...
Ia_p, ta, ang_na = Current_data(Vp, Ip, Vn, 'a')
Ib_p, tb, ang_nb = Current_data(Vp, Ip, Vn, 'b')
Ic_p, tc, ang_nc = Current_data(Vp, Ip, Vn, 'c')
