...
def fOptimal_mystic(V_mod, Imax, Zfault, type_fault, bus_fault, lam_vec, Ii_t):
    ...
    # SOLVE
    sol = my.diffev(obj_fun, Ii_t, penalty=pens, disp=True, bounds=bnds, gtol=300, ftol=1e-5, full_output=True, maxiter=100000, maxfun=100000)
