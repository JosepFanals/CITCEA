...
def fOptimal_mystic(V_mod, Imax, Zv1, Zv2, Zt, Y_con, Y_gnd, lam_vec, Ii_t):
    ...
    result = diffev(cost=obj_fun, x0=Ii_t, bounds=bnds, penalty=penalty, constraints=cf, npop=50, gtol=50, disp=True, full_output=True, ftol=1e-40, maxiter=1750000, maxfun=1750000, scale=0.5, cross=0.5)
