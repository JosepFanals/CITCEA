...
make_csv(dist_vec, np.real(I1_vec), a_vec, 'Optimal/Data/dist/RI1_re_3x.csv')
make_csv(dist_vec, np.imag(I1_vec), a_vec, 'Optimal/Data/dist/RI1_im_3x.csv')
make_csv(dist_vec, np.real(I2_vec), a_vec, 'Optimal/Data/dist/RI2_re_3x.csv')
make_csv(dist_vec, np.imag(I2_vec), a_vec, 'Optimal/Data/dist/RI2_im_3x.csv')
make_csv(dist_vec, ff_vec, a_vec, 'Optimal/Data/dist/Rff_3x.csv')

make_csv(dist_vec, np.abs(V1_vec), a_vec, 'Optimal/Data/dist/RV1_3x.csv')
make_csv(dist_vec, np.abs(V2_vec), a_vec, 'Optimal/Data/dist/RV2_3x.csv')
make_csv(dist_vec, ff_vec, a_vec, 'Optimal/Data/dist/RffG_3x.csv')
