...
make_csv(dist_vec, np.real(I1_vec), a_vec, 'Optimal/Data/dist/RI1_re_LLG.csv')
make_csv(dist_vec, np.imag(I1_vec), a_vec, 'Optimal/Data/dist/RI1_im_LLG.csv')
make_csv(dist_vec, np.real(I2_vec), a_vec, 'Optimal/Data/dist/RI2_re_LLG.csv')
make_csv(dist_vec, np.imag(I2_vec), a_vec, 'Optimal/Data/dist/RI2_im_LLG.csv')
make_csv(dist_vec, ff_vec, a_vec, 'Optimal/Data/dist/Rff_LLG.csv')

make3_csv(dist_vec, one_vec, np.abs(V1_vec), 'Optimal/Data/dist/RV1_LLG.csv')
make3_csv(zero_vec, dist_vec, np.abs(V2_vec), 'Optimal/Data/dist/RV2_LLG.csv')
make3_csv(dist_vec, dist_vec, ff_vec, 'Optimal/Data/dist/RffG_LLG.csv')
