...
\label{eq:1}
\end{equation}
where the admitances, denoted by $\un{Y}$, are the inverse of the corresponding impedances $\un{Z}$. The elements of the form $\un{Y}_{f,ij}$ form the matrix $\mathbf{Y_f}$, which turns out to be:
\begin{equation}
    \mathbf{Y_f} = 
    \begin{pmatrix}
