...
\end{itemize}
With the main aspects relative to the programming covered, we proceed to show the results for several faults. In all of them we either vary the fault impedance, the $R/X$ ratio of the $\underline{Z}_{v1}$ impedance, or the priority attributed to the voltages. In this last case, the goal is to optimize only the voltage at the PCC1. We sweep for different values of $\lambda^+_1$, where $\lambda^-_1=1-\lambda^+_1$. In all situations the currents, the voltages, and the objective function are plotted. Unless noted otherwise, the initial parameters are tabulated in Table \ref{tab:1}.
      ...
      \centering
          \begin{tikzpicture}[trim axis right,trim axis left]
              ...
              \begin{axis}[grid=major, xlabel={$\un{Y}_{xg}$}, ylabel={${I}^+_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, ytick distance={0.1}, xmin=3, xmax=10, scaled y ticks=false, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=2}]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_3x_Ip2re.csv};
              % \legend{BF, OPT};
              \end{axis}
          \end{tikzpicture}
    \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Y}_{xg}$}, ylabel={${I}^+_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=3, xmax=10, ytick distance = {0.1}]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_3x_Ip2im.csv};
                % \legend{OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Y}_{xg}$}, ylabel={${I}^-_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=3, xmax=10, ytick distance = {0.05}, ymax = 0.1, ymin=-0.1, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_3x_In2re.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_3x_In2im.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Y}_{xg}$}, ylabel={$|V^+|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=3, xmax=10, ytick distance = {0.1}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_3x_Vp2.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_3x_Vn2.csv};
                  \legend{VSC1, VSC2};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
      ...
      \centering
          \begin{tikzpicture}[trim axis right,trim axis left]
              ...
              \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^+_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, ytick distance={0.05}, xmin=0.5, xmax=5, scaled y ticks=false, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=2}]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_3x_Ip2re.csv};
              % \legend{BF, OPT};
              \end{axis}
          \end{tikzpicture}
    \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^+_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=0.5, xmax=5, ytick distance = {0.05}]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_3x_Ip2im.csv};
                % \legend{OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^-_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=0.5, xmax=5, ytick distance = {0.05}, ymax = 0.1, ymin=-0.1, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_3x_In2re.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_3x_In2im.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\vspace{0.2cm}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={$|V^+|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=0.5, xmax=5, ytick distance = {0.005}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_3x_Vp1.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_3x_Vp2.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_3x_Vn2.csv};
                  \legend{VSC1, VSC2};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\begin{subfigure}[!htb]{.7\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={$f$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.5}, axis line style = thick,  xmin=0.5, xmax=5, ytick distance = {0.002},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
...
\vspace{0.2cm}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={$|V^+|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick, xmin=0.0, xmax=0.95, ytick distance = {0.001}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
      ...
      \centering
          \begin{tikzpicture}[trim axis right,trim axis left]
              ...
              \begin{axis}[grid=major, xlabel={$\un{Y}_{ag}$}, ylabel={${I}^+_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={50}, axis line style = thick, ytick distance={0.1}, xmin=60, xmax=240, scaled y ticks=false, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=2}]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LG_Ip2re.csv};
              % \legend{BF, OPT};
              \end{axis}
          \end{tikzpicture}
    \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Y}_{ag}$}, ylabel={${I}^+_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={50}, axis line style = thick, xmin=60, xmax=240, ytick distance = {0.02}]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LG_Ip2im.csv};
                % \legend{OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Y}_{ag}$}, ylabel={${I}^-_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={50}, axis line style = thick, xmin=60, xmax=240, ytick distance = {0.05}, ymax = 0.1, ymin=-0.1, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LG_In2re.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LG_In2im.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Y}_{ag}$}, ylabel={$|V^+|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={50}, axis line style = thick, xmin=60, xmax=240, ytick distance = {0.01}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LG_Vp2.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LG_Vn2.csv};
                  \legend{VSC1, VSC2};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\begin{subfigure}[!htb]{.7\textwidth}
        ...
        \end{subfigure}
    \end{center}
    \caption{Influence of the currents on the objective function for the line to ground fault with $\un{Y}_{ag}=[60,240]$}
    \label{fig:LG_fault}
  \end{figure}
...
\begin{figure}[!htb]\centering \footnotesize
    \begin{subfigure}[!htb]{.4\textwidth}
      \centering
          \begin{tikzpicture}[trim axis right,trim axis left]
              \pgfplotsset{width=7cm, height=5.5cm}
              \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^+_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, ytick distance={0.05}, xmin=0.5, xmax=5, scaled y ticks=false, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=2}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LG_Ip1re.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LG_Ip2re.csv};
              % \legend{BF, OPT};
              \end{axis}
          \end{tikzpicture}
    \end{subfigure}
    ...
    \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^+_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=0.5, xmax=5, ytick distance = {0.01}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LG_Ip1im.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LG_Ip2im.csv};
                % \legend{OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^-_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=0.5, xmax=5, ytick distance = {0.05}, ymax = 0.1, ymin=-0.1, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LG_In1re.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LG_In2re.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=7cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^-_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick,  xmin=0.5, xmax=5, ytick distance = {0.05}, ymax = 0.1, ymin = -0.1,  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LG_In1im.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LG_In2im.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\vspace{0.2cm}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={$|V^+|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=0.5, xmax=5, ytick distance = {0.01}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LG_Vp1.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LG_Vp2.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=7cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={$|V^-|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick,  xmin=0.5, xmax=5, ytick distance = {0.0001},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=5}, ymax = 0.397, ymin=0.3965]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LG_Vn1.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LG_Vn2.csv};
                  \legend{VSC1, VSC2};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\begin{subfigure}[!htb]{.7\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LG_f_obj.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
    \end{center}
    \caption{Influence of the currents on the objective function for the line to ground with $R_1/X_1=[0.5,5]$ and $\un{Y}_{ag}=200$}
    \label{fig:LG_fault2}
  \end{figure}
...
\begin{figure}[!htb]\centering \footnotesize
    \begin{subfigure}[!htb]{.4\textwidth}
      \centering
          \begin{tikzpicture}[trim axis right,trim axis left]
              \pgfplotsset{width=7cm, height=5.5cm}
              \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={${I}^+_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick, ytick distance={0.1}, xmin=0.0, xmax=0.95, scaled y ticks=false, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=2}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LG_Ip1re.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LG_Ip2re.csv};
              % \legend{BF, OPT};
              \end{axis}
          \end{tikzpicture}
    \end{subfigure}
    ...
    \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={${I}^+_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick, xmin=0.0, xmax=0.95, ytick distance = {0.2}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LG_Ip1im.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LG_Ip2im.csv};
                % \legend{OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={${I}^-_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick, xmin=0.0, xmax=0.95, ytick distance = {0.1}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LG_In1re.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LG_In2re.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=7cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={${I}^-_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick,  xmin=0.0, xmax=0.95, ytick distance = {0.2}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LG_In1im.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LG_In2im.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={$|V^+|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick, xmin=0.0, xmax=0.95, ytick distance = {0.05}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LG_Vp1.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LG_Vp2.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=7cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={$|V^-|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick,  xmin=0.0, xmax=0.95, ytick distance = {0.05},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LG_Vn1.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LG_Vn2.csv};
                  \legend{VSC1, VSC2};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\begin{subfigure}[!htb]{.7\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=12cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={$f$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.1}, axis line style = thick,  xmin=0.0, xmax=0.95, ytick distance = {0.01},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}, scaled y ticks = false]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LG_f_obj.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
    \end{center}
    \caption{Influence of the currents on the objective function for the line to ground fault with a changing $\lambda_1$ and $\un{Y}_{ag}=200$}
    \label{fig:LG_fault3}
  \end{figure}
      ...
      \centering
          \begin{tikzpicture}[trim axis right,trim axis left]
              ...
              \begin{axis}[grid=major, xlabel={$\un{Y}_{ab}$}, ylabel={${I}^+_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, ytick distance={0.04}, xmin=10, xmax=15, scaled y ticks=false, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=2}]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LL_Ip2re.csv};
              % \legend{BF, OPT};
              \end{axis}
          \end{tikzpicture}
    \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Y}_{ab}$}, ylabel={${I}^+_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=10, xmax=15, ytick distance = {0.02}]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LL_Ip2im.csv};
                % \legend{OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Y}_{ab}$}, ylabel={${I}^-_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=10, xmax=15, ytick distance = {0.05}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LL_In2re.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LL_In2im.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Y}_{ab}$}, ylabel={$|V^+|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=10, xmax=15, ytick distance = {0.02}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LL_Vp2.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LL_Vn2.csv};
                  \legend{VSC1, VSC2};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\begin{figure}[!htb]\centering \footnotesize
    \begin{subfigure}[!htb]{.4\textwidth}
      \centering
          \begin{tikzpicture}[trim axis right,trim axis left]
              \pgfplotsset{width=7cm, height=5.5cm}
              \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^+_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, ytick distance={0.03}, xmin=1, xmax=5, scaled y ticks=false, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=2}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LL_Ip1re.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LL_Ip2re.csv};
              % \legend{BF, OPT};
              \end{axis}
          \end{tikzpicture}
    \end{subfigure}
    ...
    \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^+_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=1, xmax=5, ytick distance = {0.05}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LL_Ip1im.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LL_Ip2im.csv};
                % \legend{OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^-_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=1, xmax=5, ytick distance = {0.05}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LL_In1re.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LL_In2re.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=7cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^-_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick,  xmin=1, xmax=5, ytick distance = {0.03},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LL_In1im.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LL_In2im.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\vspace{0.2cm}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={$|V^+|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=1, xmax=5, ytick distance = {0.01}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LL_Vp1.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LL_Vp2.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=7cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={$|V^-|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick,  xmin=1, xmax=5, ytick distance = {0.005},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LL_Vn1.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LL_Vn2.csv};
                  \legend{VSC1, VSC2};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\begin{subfigure}[!htb]{.7\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=12cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={$f$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.5}, axis line style = thick,  xmin=1, xmax=5, ytick distance = {0.003},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LL_f_obj.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
    \end{center}
    \caption{Influence of the currents on the objective function for the line to line fault with $R_1/X_1=[1,5]$ and $\un{Y}_{ab}=12$}
    \label{fig:LL_fault2}
  \end{figure}
...
\begin{figure}[!htb]\centering \footnotesize
    \begin{subfigure}[!htb]{.4\textwidth}
      \centering
          \begin{tikzpicture}[trim axis right,trim axis left]
              \pgfplotsset{width=7cm, height=5.5cm}
              \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={${I}^+_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick, ytick distance={0.05}, xmin=0.0, xmax=0.7, scaled y ticks=false, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=2}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LL_Ip1re.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LL_Ip2re.csv};
              % \legend{BF, OPT};
              \end{axis}
          \end{tikzpicture}
    \end{subfigure}
    ...
    \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={${I}^+_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick, xmin=0.0, xmax=0.7, ytick distance = {0.2}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LL_Ip1im.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LL_Ip2im.csv};
                % \legend{OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={${I}^-_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick, xmin=0.0, xmax=0.7, ytick distance = {0.2}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LL_In1re.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LL_In2re.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=7cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={${I}^-_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick,  xmin=0.0, xmax=0.7, ytick distance = {0.2}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LL_In1im.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LL_In2im.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={$|V^+|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick, xmin=0.0, xmax=0.7, ytick distance = {0.05}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LL_Vp1.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LL_Vp2.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=7cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={$|V^-|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick,  xmin=0.0, xmax=0.7, ytick distance = {0.05},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LL_Vn1.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LL_Vn2.csv};
                  \legend{VSC1, VSC2};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\begin{subfigure}[!htb]{.7\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=12cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={$f$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.1}, axis line style = thick,  xmin=0.0, xmax=0.7, ytick distance = {0.04},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}, scaled y ticks = false]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LL_f_obj.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
    \end{center}
    \caption{Influence of the currents on the objective function for the line to line fault with a changing $\lambda_1$ and $\un{Y}_{ab}=50$}
    \label{fig:LL_fault3}
  \end{figure}
      ...
      \centering
          \begin{tikzpicture}[trim axis right,trim axis left]
              ...
              \begin{axis}[grid=major, xlabel={$\un{Y}_{ag}$}, ylabel={${I}^+_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, ytick distance={0.05}, xmin=3, xmax=10, scaled y ticks=false, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=2}]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LLG_Ip2re.csv};
              % \legend{BF, OPT};
              \end{axis}
          \end{tikzpicture}
    \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Y}_{ag}$}, ylabel={${I}^+_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=3, xmax=10, ytick distance = {0.01}]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LLG_Ip2im.csv};
                % \legend{OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Y}_{ag}$}, ylabel={${I}^-_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=3, xmax=10, ytick distance = {0.05}, ymin=-0.1, ymax=0.1, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LLG_In2re.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LLG_In2im.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$\un{Y}_{ag}$}, ylabel={$|V^+|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=3, xmax=10, ytick distance = {0.01}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LLG_Vp2.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  ...
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data1/opt_LLG_Vn2.csv};
                  \legend{VSC1, VSC2};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\begin{figure}[!htb]\centering \footnotesize
    \begin{subfigure}[!htb]{.4\textwidth}
      \centering
          \begin{tikzpicture}[trim axis right,trim axis left]
              \pgfplotsset{width=7cm, height=5.5cm}
              \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^+_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, ytick distance={0.03}, xmin=1, xmax=5, scaled y ticks=false, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=2}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LLG_Ip1re.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LLG_Ip2re.csv};
              % \legend{BF, OPT};
              \end{axis}
          \end{tikzpicture}
    \end{subfigure}
    ...
    \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^+_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=1, xmax=5, ytick distance = {0.01}, scaled y ticks=false, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LLG_Ip1im.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LLG_Ip2im.csv};
                % \legend{OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
        ...
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                ...
                \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^-_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=1, xmax=5, ytick distance = {0.05}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}, ymin=-0.1, ymax=0.1]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LLG_In1re.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LLG_In2re.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=7cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={${I}^-_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick,  xmin=1, xmax=5, ytick distance = {0.05},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}, ymin=-0.1, ymax=0.1]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LLG_In1im.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LLG_In2im.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\vspace{0.2cm}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={$|V^+|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick, xmin=1, xmax=5, ytick distance = {0.01}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LLG_Vp1.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LLG_Vp2.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=7cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={$|V^-|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={1}, axis line style = thick,  xmin=1, xmax=5, ytick distance = {0.001},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}, ymin=0.583, ymax=0.588]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LLG_Vn1.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LLG_Vn2.csv};
                  \legend{VSC1, VSC2};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\begin{subfigure}[!htb]{.7\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=12cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$R/X$}, ylabel={$f$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.5}, axis line style = thick,  xmin=1, xmax=5, ytick distance = {0.01},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data2/opt_LLG_f_obj.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
    \end{center}
    \caption{Influence of the currents on the objective function for the double line to ground fault with $R_1/X_1=[1,5]$ and $\un{Y}_{ag}=5$}
    \label{fig:LLG_fault2}
  \end{figure}
...
\begin{figure}[!htb]\centering \footnotesize
    \begin{subfigure}[!htb]{.4\textwidth}
      \centering
          \begin{tikzpicture}[trim axis right,trim axis left]
              \pgfplotsset{width=7cm, height=5.5cm}
              \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={${I}^+_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick, ytick distance={0.1}, xmin=0.0, xmax=0.7, scaled y ticks=false, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=2}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LLG_Ip1re.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LLG_Ip2re.csv};
              % \legend{BF, OPT};
              \end{axis}
          \end{tikzpicture}
    \end{subfigure}
    ...
    \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={${I}^+_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick, xmin=0.0, xmax=0.7, ytick distance = {0.2}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LLG_Ip1im.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LLG_Ip2im.csv};
                % \legend{OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={${I}^-_{re}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick, xmin=0.0, xmax=0.7, ytick distance = {0.2}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LLG_In1re.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LLG_In2re.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=7cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={${I}^-_{im}$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick,  xmin=0.0, xmax=0.7, ytick distance = {0.2}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LLG_In1im.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LLG_In2im.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
        \centering
            \begin{tikzpicture}[trim axis right,trim axis left]
                \pgfplotsset{width=7cm, height=5.5cm}
                \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={$|V^+|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick, xmin=0.0, xmax=0.7, ytick distance = {0.05}, yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3},]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LLG_Vp1.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LLG_Vp2.csv};
                % \legend{BF, OPT};
                \end{axis}
            \end{tikzpicture}
      \end{subfigure}
      ...
      \begin{subfigure}[!htb]{.4\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=7cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={$|V^-|$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.2}, axis line style = thick,  xmin=0.0, xmax=0.7, ytick distance = {0.05},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LLG_Vn1.csv};
                  \addplot[very thick, red, dashed] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LLG_Vn2.csv};
                  \legend{VSC1, VSC2};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
...
\begin{subfigure}[!htb]{.7\textwidth}
          \centering
              \begin{tikzpicture}[trim axis right,trim axis left]
                  \pgfplotsset{width=12cm, height=5.5cm}
                  \begin{axis}[grid=major, xlabel={$\lambda_1$}, ylabel={$f$}, /pgf/number format/.cd, legend style={at={(0.98,0.15)},anchor=south east,legend columns=1, draw=none, inner sep=0pt,fill=gray!10}, xtick distance={0.1}, axis line style = thick,  xmin=0.0, xmax=0.7, ytick distance = {0.04},  yticklabel style={/pgf/number format/fixed, /pgf/number format/precision=3}, scaled y ticks = false]
                  \addplot[very thick, black] table[x=x, y=y, col sep=comma] {Data/Data3/opt_LLG_f_obj.csv};
                  \end{axis}
              \end{tikzpicture}
        \end{subfigure}
    \end{center}
    \caption{Influence of the currents on the objective function for the double line to ground fault with a changing $\lambda_1$ and $\un{Y}_{ag}=5$}
    \label{fig:LL_fault3}
  \end{figure}
