...
Consequently, this work focuses on finding the most convenient positive and negative sequence currents (and not powers) to improve the voltage at the point of common coupling. First, a simple model is presented, and then, the results are shown together with the corresponding discussion. Despite the elegancy found in closed-form expressions, we obtain the optimal operating point by either computational brute force or an iterative process with the help of the SciPy library. The expressions regarding the several types of fault studied as well as its corresponding diagrams are shown in the appendix.
